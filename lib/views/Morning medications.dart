...
class Morning_medications extends StatefulWidget {
  const Morning_medications({super.key});

  @override
  State<Morning_medications> createState() => _Morning_medicationsState();
}

class _Morning_medicationsState extends State<Morning_medications> {
  ...
  Widget build(BuildContext context) {
    return BlocProvider(
      ...
      child: Builder(builder: (context) {
        return BlocBuilder<ConsumedMedicationBloc, ConsumedMedicationState>(
                            ...
                            return Padding(
                              ...
                              child: Card(
                                child: ListTile(
                                  ...
                                  subtitle: Text(
                                    state
                                        .consumedMedications[index].Doctor_Name,
                                    style: TextStyle(color: Colors.white),
                                  ),
                                  title: Text(
                                    state.consumedMedications[index].drug!
                                        .Drug_name,
                                    style: TextStyle(color: Colors.white),
                                  ),
                                ),
